...
public class AutonomousCarEnv_v_1 extends DefaultEnvironmentwRandomness{
	...
	public void setMAS(MAS m) {
		...
		gridCells.get( GridCell.getIndex(1, 1) ).setHasObstacle(true);
	...
	private void initPassengerList() {
		passengers.add(new Passenger("test1" , 1, 1, 3, 3) );
	...
	public Unifier executeAction(String agName, Action act) throws AILexception {	
		...
		if(actionName.equals("drive")) {
			...
			System.err.println( String.format("%s crashed in (%d,%d). Calling Emergency.", agName, carX, carY) );
